...
#[unsafe(no_mangle)]
pub(crate) extern "C" fn hex_set_log_path(_path: *const c_char) {}

#[unsafe(no_mangle)]
pub(crate) extern "C" fn hex_set_cuda_enabled(enabled: bool) {
    cuda::set_cuda_enabled(enabled);
}

#[unsafe(no_mangle)]
pub(crate) extern "C" fn hex_last_search_used_cuda() -> bool {
...
mod tests {
    ...
    fn cuda_status_export_reports_the_current_threads_marker() {
        cuda::reset_last_search_used();
        assert!(!hex_last_search_used_cuda());
